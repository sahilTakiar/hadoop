 ...
 * be passed getJclass or getName to get the jclass object or class name
 ...
 */
jclass *getJclass(enum CachedJavaClass cachedJavaClass);

/**
 * Return the class name represented by the given CachedJavaClass
 */
const char *getClassName(enum CachedJavaClass cachedJavaClass);
...
/* Some frequently used third-party paths */

#define EXCEPTION_UTILS "org/apache/commons/lang/exception/ExceptionUtils"
